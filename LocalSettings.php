...
$wgCreateWikiCannedResponses = [
	'default' => [
		'Approval reasons' => [
			...
			'Good request' => 'This is a good request. While the description could be a bit more detailed, the purpose is clear enough for approval. Please ensure your wiki always adheres to our Content Policy, as deviations from your stated scope may result in closure. Thank you for choosing WikiOasis!',
			'Okay request' => 'Conditionally approved. The purpose is somewhat vague, but other details suggest a valid use case. Please be advised that if the wiki deviates from its implied purpose or violates the Content Policy, it may be closed. Thank you.',
			'Categorized as private' => 'Your wiki request has been approved. Please note that based on its purpose, it has been categorized as a private wiki. Ensure it continues to comply with all aspects of the Content Policy. Thank you.',
		],
		'Decline reasons' => [
			...
			'Fork/Duplicate' => 'Wikis that duplicate other wikis, or substantial portions of them already on WikiOasis are not allowed. This includes "forks". We wish you the best in trying to find a home for this project.',
